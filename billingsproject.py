...
#Function to get total prices
    def total(self):
        ...
        self.total_food_prices = (
            (self.bread.get() * 50)+
            (self.candy.get() * 10)+
            (self.hamburger.get() * 25)+
            (self.hotdog.get() * 25)+
            (self.sandwich.get() * 20)
        )
        ...
        self.total_other_prices = (
            (self.gatorade.get() * 20)+
            (self.juice.get() * 10)+
            (self.coke.get() * 20)+
            (self.waffer.get() * 10)+
            (self.biscuits.get() * 10)
        )
...
#Add Product name , qty and price to bill area
    def bill_area(self):
        ...
        if self.candy.get() != 0:
            self.txt.insert(END,f"\nCandy             {self.candy.get()}           {self.candy.get() * 10}")
        if self.hamburger.get() != 0:
            self.txt.insert(END,f"\nHamburger         {self.hamburger.get()}           {self.hamburger.get() * 25}")
        if self.hotdog.get() != 0:
            self.txt.insert(END,f"\nHotdog            {self.hotdog.get()}           {self.hotdog.get() * 25}")
        if self.sandwich.get() != 0 :
            self.txt.insert(END,f"\nSandwich          {self.sandwich.get()}           {self.sandwich.get() * 20}")
        if self.wheat.get() != 0:
            self.txt.insert(END,f"\nWheat             {self.wheat.get()}           {self.wheat.get() * 100}")
        if self.food_oil.get() != 0:
            self.txt.insert(END,f"\nFood Oil          {self.food_oil.get()}           {self.food_oil.get() * 80}")
        if self.salt.get() != 0:
            self.txt.insert(END,f"\nSalt              {self.salt.get()}           {self.salt.get() * 50}")
        if self.rice.get() != 0:
            self.txt.insert(END,f"\nRice              {self.rice.get()}           {self.rice.get() * 100}")
        if self.sugar.get() != 0:
            self.txt.insert(END,f"\nSugar             {self.sugar.get()}           {self.sugar.get() * 50}")
        if self.gatorade.get() != 0:
            self.txt.insert(END,f"\nGatorade          {self.gatorade.get()}           {self.gatorade.get() * 20}")
        if self.juice.get() != 0:
            self.txt.insert(END,f"\nJuice             {self.juice.get()}           {self.juice.get() * 10}")
        if self.coke.get() != 0:
            self.txt.insert(END,f"\nCoke              {self.coke.get()}           {self.coke.get() * 20}")
        if self.waffer.get() != 0:
            self.txt.insert(END,f"\nWaffer            {self.waffer.get()}           {self.waffer.get() * 10}")
        if self.biscuits.get() != 0:
            self.txt.insert(END,f"\nBiscuits          {self.biscuits.get()}           {self.biscuits.get() * 10}")
        self.txt.insert(END,"\n===================================")
